<div class="container-fluid">
  <div class="row">
    <h1 class="title1">A propos</h1>
  </div>
  <div class="row center">
    <div class="col-2"></div>
    <div class="col-8">
      <p class=textAPropos>
        Lorem ipsum dolor sit amet, consectetur adipiscing elit. Nam justo nisi, venenatis at tincidunt suscipit, aliquet in justo. Proin ultricies ligula ut vulputate dapibus. Etiam vel sapien facilisis, viverra leo sit amet, vestibulum turpis. Nunc felis risus, volutpat non commodo tempor, volutpat in felis. Integer tincidunt elementum euismod. In pellentesque lacus et aliquam lacinia. Aliquam non neque quis ante congue faucibus vel sed risus. Quisque vehicula lectus et ex porttitor mattis. Phasellus commodo eros vitae porttitor ultrices. Aenean tincidunt, lectus non iaculis volutpat, risus mauris mattis dui, eu blandit quam orci non lorem. Nulla pretium, ex eget congue scelerisque, orci mauris dapibus enim, in laoreet purus quam feugiat ligula. Donec non arcu a sem ullamcorper bibendum at non mauris. Duis nec faucibus libero, pellentesque sodales magna. Aenean quis nulla tempor, efficitur nibh ac, pellentesque diam. In pretium justo augue, sit amet aliquam augue rhoncus ut. Etiam porta nunc ut lobortis convallis.
      </p>
      <p class="textAPropos">
